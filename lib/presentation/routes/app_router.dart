...
import '../screen/move/profile_screen.dart';
import 'all_route_list.dart';
import 'package:flutter_example_base/presentation/screen/move/home_screen.dart';
import 'package:flutter_example_base/presentation/screen/move/search_query_screen.dart';
      ...
      routes: [
        ...
        GoRoute(
          ...
          pageBuilder: (context, state) {
            // final keyword = state.uri.queryParameters['keyword'] ?? '';
            // return SearchQueryScreen(keyword: keyword);
            return NoTransitionPage(child: SearchQueryScreen());
          },
          routes: [
            GoRoute(
              path: 'detail',
