...
/// ㄴ
class CommonNavEdgePage extends ConsumerStatefulWidget {
  ///
  /// Scaffold 설정
  ///
  final Widget? appBar;
  ...
  @override
  ConsumerState<CommonNavEdgePage> createState() => _CommonNavEdgePageState();
}

class _CommonNavEdgePageState extends BaseConState<CommonNavEdgePage> {
  bool? isDark = false;
  bool? isBlur = true;
  Color? overlayColor;
